...
public class KenThompson extends Event{
    ...
    public void execute() {
        KenThompson arr = new KenThompson();
        System.out.println("Number of Edge added :" + arr.edge_num);
        arr.addEdge(arr.edge_num);
        System.out.println("\nPath between you(1) to Ken Thompson(8) :");
        boolean[] isV = new boolean[arr.friend + 1];
        ArrayList<Integer> path = new ArrayList();
        path.add(1);
        arr.printAllPath(1, 8, isV, path);
        System.out.println("\nThe maximum hop of path is " + arr.maxhop);
        System.out.println("\nThere is only "+arr.exceptionPath+" path that have more than 6 hop.");
    }
}
